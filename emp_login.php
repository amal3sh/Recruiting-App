...
<form class="form-signin" method="post" action="emp_sign_in.php" style="width:300px; margin:auto">
<div class="container">
 ...
 <center><button class="btn btn-outline-primary" type="submit" style="width:100px; margin:auto">Sign in</button></center>
